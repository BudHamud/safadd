...
export const ProfileMenuView = ({
    ...
    return (
        <>
            ...
            {showAdminReports && (
                <div className="profile-row-item" onClick={onOpenAdminReports}>
                    <div className="profile-row-icon">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <div className="profile-row-content">
                        <div className="profile-row-sublabel">{t('profile.admin_reports_title')}</div>
                        <div className="profile-row-value">{t('profile.admin_reports_desc')}</div>
                    </div>
                    <div className="profile-row-arrow">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                            <polyline points="9 18 15 12 9 6" />
