...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  { id: 'organic-light', name: 'Light', emoji: '', isDark: false, colors: Light },
  ...
  { id: 'arctic', name: 'Artico', emoji: '', isDark: false, colors: Arctic },
  { id: 'purple', name: 'Morado', emoji: '', isDark: true, colors: Purple },
  { id: 'mono', name: 'Mono', emoji: '', isDark: true, colors: Mono },
];
