  ...
  return (
    <SafeAreaView style={[s.root, { backgroundColor: C.bg }]} edges={['top']}>
      <ScrollView contentContainerStyle={s.scroll}>
        ...
        <RowItem
          iconChar="⚑"
          label={t('mobile.debug.row_label')}
          value={t('mobile.debug.row_sub')}
          onPress={() => { haptic.selection(); setActiveSection('debug'); }}
          C={C}
        />
...
const s = StyleSheet.create({
  ...
  overlayViewport: { flex: 1, justifyContent: 'flex-end' },
  currencyModal: {
    borderTopWidth: 1,
    borderLeftWidth: 1,
    borderRightWidth: 1,
