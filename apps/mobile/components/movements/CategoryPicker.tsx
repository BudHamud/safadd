        ...
        {search.trim().length > 0 && filtered.length === 0 ? (
          <View style={styles.createWrap}>
            ...
            <TouchableOpacity
              ...
              onPress={() => onSelect(search.trim().toUpperCase(), newEmoji)}
            >
              <Text style={[styles.createText, { color: C.primaryText }]}>{newEmoji} {t('mobile.category.create')} {search.trim().toUpperCase()}</Text>
            </TouchableOpacity>
          </View>
        ) : null}
