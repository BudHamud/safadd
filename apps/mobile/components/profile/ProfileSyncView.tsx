...
import { DeviceEventEmitter, View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Switch, ScrollView } from 'react-native';
        ...
        <View style={[styles.card, { backgroundColor: C.surface, borderColor: C.border }]}>
          <View style={styles.inlineRow}>
            ...
            <Switch
              ...
              onValueChange={handleToggleSyncMode}
