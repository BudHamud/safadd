...
const styles = StyleSheet.create({
  ...
  cardDesc: { fontSize: FontSize.sm, marginBottom: Spacing.md, lineHeight: 20 },
  btn: {
    paddingVertical: Spacing.md, borderRadius: Radius.block,
    alignItems: 'center', justifyContent: 'center',
  },
  btnText: { fontSize: FontSize.sm, fontWeight: FontWeight.black, letterSpacing: 1 },
