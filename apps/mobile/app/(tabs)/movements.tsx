...
import { ChevronDown, Plus, SlidersHorizontal, Search, X } from 'lucide-react-native';
    ...
    <SafeAreaView style={[styles.wrapper, { backgroundColor: C.bg }]} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity
            style={[styles.iconBtn, { backgroundColor: C.primary, borderColor: C.primary }]}
            onPress={handleNewTx}
          >
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <TouchableOpacity style={[styles.emptyBtn, { borderColor: C.primary }]} onPress={handleNewTx}>
                <Text style={[styles.emptyBtnText, { color: C.primary }]}>{t('movements.add_first').toUpperCase()}</Text>
              </TouchableOpacity>
            </View>
          }
          ListFooterComponent={
            <View style={styles.footerPanel}>
              ...
              <View style={[styles.insightsCard, { backgroundColor: C.surface, borderColor: C.border }]}>
                <View style={[styles.insightsHeader, { borderBottomColor: C.borderDim }]}>
                  ...
                  <Text style={[styles.insightsTitle, { color: C.textMain }]}>{t('movements.sidebar_top_cats').toUpperCase()}</Text>
                </View>
                ...
                <View style={[styles.balanceBlock, { borderBottomColor: C.borderDim }]}>
                  ...
                  <View style={styles.balanceSubRow}>
                    <View style={styles.balanceSubItem}>
                      <Text style={[styles.balanceSubLabel, { color: C.incomeText }]}>↑ {t('common.income').toUpperCase()}</Text>
                    ...
                    <View style={styles.balanceSubItem}>
                      <Text style={[styles.balanceSubLabel, { color: C.expenseText }]}>↓ {t('common.expenses').toUpperCase()}</Text>
      ...
      <Modal visible={showPeriodModal} transparent animationType="fade" onRequestClose={() => setShowPeriodModal(false)}>
        <View style={styles.periodModalOverlay}>
          ...
          <SafeAreaView style={styles.periodModalViewport} edges={['bottom']}>
...
const styles = StyleSheet.create({
  ...
  balanceBlock: { gap: 8, paddingBottom: Spacing.sm, borderBottomWidth: 1 },
  ...
  // Goal donut panel
  goalPanel: { borderTopWidth: 1, paddingTop: Spacing.sm },
  goalDonutRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md },
  ...
  // Top categories
  topCatsPanel: { gap: Spacing.sm },
  noCats: { fontSize: FontSize.sm, fontWeight: FontWeight.medium },
  catRow: { gap: 4 },
  catCopy: { flexDirection: 'row', justifyContent: 'space-between', gap: Spacing.sm },
  ...
  catBarTrack: { height: 4, borderRadius: 2 },
