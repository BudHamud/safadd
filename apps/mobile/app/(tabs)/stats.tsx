                ...
                <View style={[styles.goalSection, { borderTopColor: C.border }]}>
                  ...
                  <View style={[styles.goalTrack, { borderColor: C.border, backgroundColor: C.surfaceAlt }]}>
                    <View
                      style={[
                        styles.goalFill,
                        { width: `${goalProgress}%` as const, backgroundColor: goalProgress >= 100 ? C.expenseText : C.primary },
                      ]}
                    />
                  </View>
                </View>
                    ...
                    >
                      <View
                        style={[
                          ...
                          { width: `${pct}%` as const, backgroundColor: C.primary, opacity: index === 0 ? 1 : index === 1 ? 0.6 : 0.4 },
                        ]}
                      />
